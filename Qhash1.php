...
function encoder($a){
		...
		function one($a){
						...
						//$diz is must be an array that which you will encode sentence languages 's alphabet.
						...
						//$diz2 is encode array you can add any character you want. But must be count($diz)==count($diz2).
						$diz2=array("॥","১","২","৩","৪","৫","৬","৭","৮","৯","০","ৃ","ৌ","ৈ","া","ী","ূ","ব","হ","গ","দ","জ","ড","়","ো","ে","্","ি","ু","প","র","ক","ত","চ","ট","ং","ম","ন","ব","ল","স","য়","ঔ","ঐ","আ","ঈ","ঊ","ভ","ঙ","ঘ","ধ","ঝ","ঢ","ঞ","ও","এ","অ","ই","উ","ফ","ৎ","খ","থ","ছ","ঠ","ঁ","ণ","শ","ষ","।","й","ц","у","к","е","н","г","ш","ў","з","ф","ы","в","а","п","р","о","л","д","я");
									...
									for($x=0;$x<count($diz);$x++){                   

													$a=preg_replace("/".$diz[$x]."/",$diz2[$x],$a);						
